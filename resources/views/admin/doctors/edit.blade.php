    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="forms-sample" method="post" action="{{route('doctors.update', [$user->id])}}"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                       value="{{$user->name}}" placeholder="doctor name">
                                @error('name')
                                ...
                                <select name="department" class="form-control">
                                    @foreach(App\Department::all() as $department)
                                        <option value="{{$department->department}}"
                                                @if($user->department == $department->department) selected @endif>{{$department}}</option>
                                    @endforeach
                                </select>
                                @error('department')
                                <span class="invalid-feedback" role="alert">
